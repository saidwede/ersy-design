...
;function wn(a,b){var c=void 0===c?{}:c;if(R("migrate_events_to_ts")){c=void 0===c?{}:c;var d=vm;P("ytLoggingEventsDefaultDisabled",!1)&&vm===vm&&(d=null);R("web_all_payloads_via_jspb")&&Mh(new kj("Logs should be translated to JSPB but are sent as JSON instead",a));rn(a,b,d,c)}else d=vm,P("ytLoggingEventsDefaultDisabled",!1)&&vm==vm&&(d=null),rn(a,b,d,c)}
